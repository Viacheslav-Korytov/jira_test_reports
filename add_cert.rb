...
uri = URI('https://tms.netcracker.com/:443')
...
if http.use_ssl?
  ...
  http.cert_store.add_file('c:\\ssl\\cacert.pem')
  # ...or:
  cert = OpenSSL::X509::Certificate.new(File.read('C:\\SSL\\cacert_nc.pem'))
  http.cert_store.add_cert(cert)
  cert = OpenSSL::X509::Certificate.new(File.read('C:\\SSL\\nccert.cer'))
  http.cert_store.add_cert(cert)
  #http.cert_store.add_file('C:\\SSL\\nccert.cer')
